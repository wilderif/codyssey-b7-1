...
_ALGORITHM = "pbkdf2_sha256"    #Password-Based Key Derivation Function, sha256 알고리즘 사용
_ITERATIONS = 600_000   # SHA256은 결과가 너무 빨리 나오므로 반복실행하여 brute-force 공격을 어렵게 한다.
_SALT_BYTES = 16    # 값을 더해서 같은 비밀번호도 다르게 저장. 레인보우 테이블 공격을 어렵게 한다.
...
def verify_password(password: str, encoded_hash: str) -> bool:
    ...
    return hmac.compare_digest(candidate_key, expected_key) # 불일치 타이밍을 계산해서 공격자가 추측하지 못하도록 안전하게 비교한다.
